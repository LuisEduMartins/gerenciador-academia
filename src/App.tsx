...
import { Membro, PlanoDeTreino, Exercicio, Instrutor } from './types/models';
  ...
  return (
    <div className="App">
      <header className="App-header">
        <h1>Academia para evitar o sedentarismo</h1>
      </header>
      ...
      <footer style={{padding: "2rem", color: "#555"}}>
        <p>Projeto SPA com React e TypeScript.</p>
      </footer>
    </div>
  );
}
